  ...
  return (
    <header className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-10">
      ...
      <div className="animate-fade-in stagger-delay-1">
        ...
        <div className="mt-4 flex space-x-4 animate-fade-in stagger-delay-2">
          {socialLinks.map((link) => (
            <a
              ...
              className="text-gray-400 hover:text-sky-400 transition-all duration-200 hover:scale-110"
